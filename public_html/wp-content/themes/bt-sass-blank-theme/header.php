...
<body <?php echo body_class(); ?>>
    <nav id="navbar" class="navbar fixed-top navbar-expand-lg navbar-dark bg-primary p-1">
        <div class="container">
            ...
            <div class="d-flex justify-content-sm-center w-lg-100">
                <?php if(has_custom_logo()):
            ...
            <div  id="navbarNav" class="navbar-collapse collapse collapse-right">
                <button class="btn btn-link text-decoration-none text-dark position-absolute navbar-toggler mt-2 mr-2"  data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" style="right:0;">
